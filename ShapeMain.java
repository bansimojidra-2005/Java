/*Write a java program to create an abstract class named shape with the following features:
	1.Feilds: Two integer fileds(e.g.,for dimensions like length,width,radious, etc.)
	2.Abstract Methods:
		. public abstract double area() This method should calculate and return the area of shape.
		. public abstract double perimeter() This method should calculate and return the perimeter(or circumference) of the shape.
	...
	Each of the subxlasses should have their own constructors and the area() and perimeter() methods should be properly overriden.
	*/
 ...
 public class ShapeMain
{
	public static void main(String args[])
	{
		...
		System.out.println("--------------------------------------------");
		System.out.println();
		Triangle t = new Triangle(5,8,10,20,30);
